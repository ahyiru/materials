...
/* harmony default export */ var materials_animation_fliper = (Fliper);
...
/* harmony default export */ var materials_border_titleHeader = (TitleHeader);
...
/* harmony default export */ var materials_border_cornerBorder = (CornerBorder);
...
/* harmony default export */ var materials_border_halfBorder = (HalfBorder);
...
/* harmony default export */ var materials_border_bgBox = (BgBox);
...
/* harmony default export */ var materials_border_titleBorder = (TitleBorder);
...
/* harmony default export */ var materials_border_animateBorder = (AnimateBorder);
...
const randColors = (colors) => (colors == null ? void 0 : colors.length) ? utils_randItem(colors) : utils_randColor();
const Barchart = ({ list = 10, height = "240px", space = "25px", itemWidth = "30px", colors = [], color, style, className, ...rest }) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: `${chart_barchart["huxy-skeleton-barchart"]}${className ? ` ${className}` : ""}`, style: {
  "--height": height,
  ...style
}, ...rest, children: (Array.isArray(list) ? list : [...new Array(list)]).map((item, i) => {
  var _a, _b, _c;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      style: {
        "--space": space,
        "--itemWidth": itemWidth,
        "--bgColor": (_b = (_a = item == null ? void 0 : item.color) != null ? _a : color) != null ? _b : `linear-gradient(to top, ${randColors(colors)}, ${randColors(colors)})`,
        "--itemHeight": (_c = item == null ? void 0 : item.height) != null ? _c : `${utils_randNum(15, 100)}%`,
...
/* harmony default export */ var materials_chart_barchart = (Barchart);
...
/* harmony default export */ var materials_chart_card = (Card);
...
/* harmony default export */ var materials_chart_circle = (Circle);
...
/* harmony default export */ var materials_chart_dashboard = (Dashboard);
...
/* harmony default export */ var huxy_materials_chart_list = (List);
...
const piechart_randColors = (colors) => (colors == null ? void 0 : colors.length) ? utils_randItem(colors) : utils_randColor();
...
/* harmony default export */ var materials_chart_piechart = (Piechart);
...
/* harmony default export */ var materials_chart_progress = (Progress);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: `${chart_ring["huxy-animate-border-ring"]}${className ? ` ${className}` : ""}`, style: {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        style: {
          "--color": (_b = (_a = item == null ? void 0 : item.color) != null ? _a : color) != null ? _b : utils_randColor(),
...
/* harmony default export */ var materials_chart_ring = (Ring);
...
/* harmony default export */ var materials_chart_container = (Container);
...
/* harmony default export */ var materials_chart_table = (Table);
...
/* harmony default export */ var materials_chart_wave = (Wave);
...
/* harmony default export */ var materials_shape_time = (Time);
...
/* harmony default export */ var materials_shape_search = (Search);
...
/* harmony default export */ var huxy_materials_shape_location = (Location);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: (Array.isArray(list) ? list : [...new Array(list)]).map((item, i) => {
        var _a, _b, _c;
        return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: shape_loading.ball, style: {
          "--delay": (_b = item == null ? void 0 : item.delay) != null ? _b : `${time / (((_a = list == null ? void 0 : list.length) != null ? _a : list) + 1) * (i + 1) - time}s`,
          "--bgColor": (_c = item == null ? void 0 : item.color) != null ? _c : utils_randColor()
        } }, `huxy-loading-ball-${i}`);
      })
    }
  );
};
/* harmony default export */ var materials_shape_loading = (Loading);
...
/* harmony default export */ var materials_shape_taiji = (Taiji);
...
const text3d_randColors = (colors) => (colors == null ? void 0 : colors.length) ? utils_randItem(colors) : utils_randColor();
const text3d_RandCarousel = ({ list = [], colors = [], width, padding, bgColor, style, ...rest }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "huxy-text-3d", style: {
    ...
    const _time = (_a = item.time) != null ? _a : utils_randNum(6, 24, false).toFixed(2);
    const _delay = (_b = item.delay) != null ? _b : -utils_randNum(0, _time, false).toFixed(2);
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        style: {
          "--time": `${_time}s`,
          "--center": (_c = item.center) != null ? _c : `${randCnter()}%`,
          "--rotate": (_d = item.rotate) != null ? _d : `${randRotate()}deg`,
          "--size": (_e = item.size) != null ? _e : randSize(),
          "--color": (_f = item.color) != null ? _f : text3d_randColors(colors),
          "--delay": `${_delay}s`
...
/* harmony default export */ var materials_text_textFilter = (TextFilter);
...
/* harmony default export */ var materials_text_textLoading = (TextLoading);
...
const RateScore = ({ score = 0, backColor = "rgba(0, 0, 0, 0.3)", frontColor = "var(--yellow2)", style, className, children, backend, ...rest }) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: `${text_rateScore["huxy-rate-score"]}${className ? ` ${className}` : ""}`, style: {
  ...
  ...style
}, ...rest, "data-text": children, children: backend != null ? backend : children });
/* harmony default export */ var materials_text_rateScore = (RateScore);
