...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(d))))," */")),s.styleTagTransform(o,a,s.options)}function t(a){if(a.parentNode===null)return!1;a.parentNode.removeChild(a)}function i(a){if(typeof document>"u")return{update:function(){},remove:function(){}};var s=a.insertStyleElement(a);return{update:function(o){e(s,a,o)},remove:function(){t(s)}}}r.exports=i},656:r=>{function e(t,i){if(i.styleSheet)i.styleSheet.cssText=t;else{for(;i.firstChild;)i.removeChild(i.firstChild);i.appendChild(document.createTextNode(t))}}r.exports=e}},Zt={};function p(r){var e=Zt[r];if(e!==void 0)return e.exports;var t=Zt[r]={id:r,exports:{}};return tr[r](t,t.exports,p),t.exports}p.n=r=>{var e=r&&r.__esModule?()=>r.default:()=>r;return p.d(e,{a:e}),e},p.d=(r,e)=>{for(var t in e)p.o(e,t)&&!p.o(r,t)&&Object.defineProperty(r,t,{enumerable:!0,get:e[t]})},p.o=(r,e)=>Object.prototype.hasOwnProperty.call(r,e),p.r=r=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(r,"__esModule",{value:!0})},p.nc=void 0;var v={};p.d(v,{sC:()=>Ir,S9:()=>Yr,ji:()=>Sr,Zp:()=>Fr,jl:()=>Jr,mc:()=>_e,ax:()=>Dr,e8:()=>Qt,xh:()=>Zr,Lv:()=>ur,C7:()=>Or,De:()=>cr,yz:()=>yr,ve:()=>Me,B8:()=>Qr,Rh:()=>ge,aZ:()=>fe,VJ:()=>ee,ke:()=>ae,LI:()=>$e,Jn:()=>ie,vj:()=>me,P1:()=>Ae,XI:()=>le,cp:()=>Pe,xw:()=>Le,U$:()=>We,E8:()=>Ue,dF:()=>we,gX:()=>ve,nQ:()=>Lr,Ub:()=>Cr,wH:()=>pe});var Ft={};p.r(Ft),p.d(Ft,{"bg-box-cube":()=>D.a6,"bg-box-cubestrip":()=>D.sI,"bg-box-dot":()=>D.W6,"bg-box-grid":()=>D.jX,"bg-box-img":()=>D.Oe,"bg-box-strip":()=>D.tY,default:()=>Tr});var Nt={};p.r(Nt),p.d(Nt,{default:()=>Br,"huxy-border-animate-dash":()=>S.Rn,"huxy-border-animate-solid":()=>S.c6,"huxy-border-wrap":()=>S.DV});var Ht={};p.r(Ht),p.d(Ht,{default:()=>Ee,"huxy-scale":()=>ht.mj,"huxy-spot":()=>ht.KC});var l=p(85);const rr=r=>r?.$$typeof&&typeof r.$$typeof=="symbol"&&r.$$typeof.description?.indexOf("react.")===0,Vt=rr,er=(r,e="px")=>`${r}`.replace(e,"")-0,j=er;var or=p(591),h=p.n(or),ar=p(740),m=p.n(ar),sr=p(128),x=p.n(sr),ir=p(855),f=p.n(ir),nr=p(51),b=p.n(nr),_r=p(656),g=p.n(_r),Kt=p(673),B={};B.styleTagTransform=g(),B.setAttributes=f(),B.insert=x().bind(null,"head"),B.domAPI=m(),B.insertStyleElement=b();var yo=h()(Kt.A,B);const Ao=Kt.A&&Kt.A.locals?Kt.A.locals:void 0,dr=({list:r=[],size:e="360px",cardSize:t="42px",bottom:i="60px",style:a,...s})=>{const n=360/r.length;return(0,l.jsx)("div",{className:"huxy-css-3d-models",style:{"--size":e,"--cardSize":t,"--bottom":i,...a},...s,children:(0,l.jsx)("div",{className:"model-container",children:r.map((o,_)=>(0,l.jsx)("div",{className:"model-item",style:{"--rotateY":`${n*_}deg`},children:(0,l.jsxs)("a",{className:"model-card huxy-css-3d-models-tooltip",tooltip:o.label,href:o.link,target:"_blank",children:[o.icon?(0,l.jsx)("img",{src:o.icon,alt:o.label}):null,Vt(o.icon)?o.icon:o.icon?(0,l.jsx)("img",{src:o.icon,alt:o.label}):null]})},o.label))})})},Qt=dr;var $t=p(316),W={};W.styleTagTransform=g(),W.setAttributes=f(),W.insert=x().bind(null,"head"),W.domAPI=m(),W.insertStyleElement=b();var Co=h()($t.A,W);const Po=$t.A&&$t.A.locals?$t.A.locals:void 0,lr=({objs:r=[],models:e=[],height:t="480px",style:i,className:a,...s})=>(0,l.jsxs)("div",{className:`huxy-icon-animate-container${a?` ${a}`:""}`,style:{"--height":t,...i},...s,children:[(0,l.jsx)("div",{className:"huxy-icon-animate-materiels",children:r.map(({value:n,label:o,icon:_,link:d,type:c,style:y})=>(0,l.jsx)("a",{className:`huxy-icon-animate-tooltip obj-${n}${c?"":" obj-img"}`,tooltip:c?void 0:o,href:d,target:"_blank",style:y,children:Vt(_)?_:(0,l.jsx)("img",{src:_,alt:o})},o))}),(0,l.jsx)(Qt,{list:e,size:`${j(t)-120}px`})]}),cr=lr;var R=p(92),I={};I.styleTagTransform=g(),I.setAttributes=f(),I.insert=x().bind(null,"head"),I.domAPI=m(),I.insertStyleElement=b();var Do=h()(R.Ay,I);const Mo=R.Ay&&R.Ay.locals?R.Ay.locals:void 0,pr=({front:r,back:e,...t})=>(0,l.jsx)("div",{className:R.fj,...t,children:(0,l.jsxs)("div",{className:R.Nr,children:[(0,l.jsx)("div",{className:R.Wm,children:r}),(0,l.jsx)("div",{className:R.aX,children:e})]})}),ur=pr;var vr=r=>{var e={};return p.d(e,r),e},Oo=r=>()=>r;const O=vr({useCallback:()=>Dt.useCallback,useEffect:()=>Dt.useEffect,useMemo:()=>Dt.useMemo,useRef:()=>Dt.useRef,useState:()=>Dt.useState}),hr=(r={})=>{const e=(0,O.useRef)(0),[t,i]=(0,O.useState)(r),a=(0,O.useCallback)(s=>{cancelAnimationFrame(e.current),e.current=requestAnimationFrame(()=>i(s))},[]);return(0,O.useEffect)(()=>()=>cancelAnimationFrame(e.current),[]),[t,a]},mr=hr,xr=(r,e)=>{const t=(0,O.useRef)();(0,O.useEffect)(()=>{t.current=r},[r]),(0,O.useEffect)(()=>{if(e){const i=setInterval(()=>t.current(),e);return()=>clearInterval(i)}},[e])},fr=xr;var Xt=p(183),U={};U.styleTagTransform=g(),U.setAttributes=f(),U.insert=x().bind(null,"head"),U.domAPI=m(),U.insertStyleElement=b();var To=h()(Xt.A,U);const Ro=Xt.A&&Xt.A.locals?Xt.A.locals:void 0,br=(r,e=60)=>(e=1.5*e,r.map((t,i)=>{const a=Math.random();let s=1;a<.3334?s=1.2:a<.6667&&(s=.8);const n=~~(i/3),o=i%3;let _=1.5*e*n;o===1&&(_+=e/2);const d=o*e+e/6*(o+1);return t.transform={x:_,y:d,s},t})),gr=(r,e=60)=>(e=2.25*e,r.map(t=>(t.transform.x-=2,t.transform.x+e<0&&(t.transform.x=~~(r.length/3)*e),t))),Er=({width:r=60,wait:e=56,list:t=[],className:i,...a})=>{const s=(0,O.useMemo)(()=>br(t,r),[]),[n,o]=mr(s),[_,d]=(0,O.useState)(e);fr(()=>{const E=gr(n,r);o(E)},_);const c=E=>{d(null)},y=E=>{d(e)};return(0,l.jsx)("div",{className:`huxy-icon-carousel${i?` ${i}`:""}`,...a,children:(0,l.jsx)("div",{className:"icon-container",children:n.map((E,u)=>(0,l.jsx)("a",{className:`icon-item huxy-icon-carousel-tooltip-${u%3===0?"lt":"lb"}`,tooltip:E.label,style:{transform:`translate(${E.transform.x}px, ${E.transform.y}px) scale(${E.transform.s})`,width:r},onMouseEnter:c,onMouseLeave:y,href:E.link,target:"_blank",children:(0,l.jsx)("img",{src:E.icon,alt:E.label})},E.label))})})},yr=Er;var z=p(529),w={};w.styleTagTransform=g(),w.setAttributes=f(),w.insert=x().bind(null,"head"),w.domAPI=m(),w.insertStyleElement=b();var So=h()(z.Ay,w);const jo=z.Ay&&z.Ay.locals?z.Ay.locals:void 0,Ar=({title:r,borderColor:e,titleWidth:t,titleHeight:i,style:a,className:s,...n})=>(0,l.jsx)("div",{className:`${z.s5}${s?` ${s}`:""}`,style:{"--borderColor":e,"--titleWidth":t,"--titleHeight":i,...a},...n,children:(0,l.jsx)("h2",{className:z.DD,children:r})}),Cr=Ar;var T=p(737),K={};K.styleTagTransform=g(),K.setAttributes=f(),K.insert=x().bind(null,"head"),K.domAPI=m(),K.insertStyleElement=b();var Lo=h()(T.Ay,K);const Bo=T.Ay&&T.Ay.locals?T.Ay.locals:void 0,Pr=({size:r="8px",borderColor:e="var(--appColor)",half1:t=!0,half2:i=!0,style:a,className:s,children:n,...o})=>(0,l.jsx)("div",{className:`${T.Lm}${s?` ${s}`:""}`,style:{"--cornerSize":r,"--borderColor":e,...a},...o,children:(0,l.jsxs)("div",{className:`${T.WO}${t?` ${T.MX}`:""}`,children:[i?(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)("span",{className:T.HA}),(0,l.jsx)("span",{className:T.JJ})]}):null,n]})}),Dr=Pr;var $=p(885),X={};X.styleTagTransform=g(),X.setAttributes=f(),X.insert=x().bind(null,"head"),X.domAPI=m(),X.insertStyleElement=b();var Wo=h()($.Ay,X);const Io=$.Ay&&$.Ay.locals?$.Ay.locals:void 0,Mr=({size:r="8px",borderColor:e="var(--appColor)",style:t,className:i,children:a,...s})=>(0,l.jsx)("div",{className:`${$.Lm}${i?` ${i}`:""}`,style:{"--cornerSize":r,"--borderColor":e,...t},...s,children:(0,l.jsx)("div",{className:$.OP,children:a})}),Or=Mr;var D=p(302),Y={};Y.styleTagTransform=g(),Y.setAttributes=f(),Y.insert=x().bind(null,"head"),Y.domAPI=m(),Y.insertStyleElement=b();var Uo=h()(D.Ay,Y);const Tr=D.Ay&&D.Ay.locals?D.Ay.locals:void 0,Rr=({type:r="dot",bgColor:e,cubeColor:t,url:i,style:a,className:s,children:n,...o})=>{r=i?"img":r;const _=i?{backgroundImage:`url(${i})`}:void 0;return(0,l.jsx)("div",{className:`${Ft[`bg-box-${r}`]}${s?` ${s}`:""}`,style:{"--bgColor":e,"--cubeColor":t,..._,...a},...o,children:n})},Sr=Rr;var L=p(230),k={};k.styleTagTransform=g(),k.setAttributes=f(),k.insert=x().bind(null,"head"),k.domAPI=m(),k.insertStyleElement=b();var zo=h()(L.Ay,k);const wo=L.Ay&&L.Ay.locals?L.Ay.locals:void 0,jr=({children:r,title:e,fontSize:t,borderSize:i,borderColor:a="var(--appColor)",space:s="10px",style:n,className:o,..._})=>(0,l.jsxs)("div",{className:`${L.Qo}${o?` ${o}`:""}`,style:{"--borderColor":a,"--space":s,"--fontSize":t,"--borderSize":i,...n},..._,children:[(0,l.jsx)("div",{className:L.d0,children:e}),(0,l.jsx)("div",{className:L.fc,children:r})]}),Lr=jr;var S=p(871),F={};F.styleTagTransform=g(),F.setAttributes=f(),F.insert=x().bind(null,"head"),F.domAPI=m(),F.insertStyleElement=b();var Ko=h()(S.Ay,F);const Br=S.Ay&&S.Ay.locals?S.Ay.locals:void 0,Wr=({type:r="solid",space:e="2px",borderColor:t="var(--appColor)",style:i,className:a,children:s,...n})=>(0,l.jsx)("div",{className:`${S.DV}${a?` ${a}`:""}`,style:{"--space":e,"--borderColor":t,...i},...n,children:(0,l.jsx)("div",{className:Nt[`huxy-border-animate-${r==="dash"?"dash":"solid"}`],children:s})}),Ir=Wr,Ur=(r="",e=2,t="0")=>{const i=r.length;return i>=e?r:`${Array(e-i+1).join(t)}${r}`},zr=Ur,wr=()=>"#"+zr((~~(Math.random()*(1<<24))).toString(16),6),A=wr,Kr=(r=0,e=0,t=!0)=>(r<e&&(r=[e,e=r][0]),t?~~(Math.random()*(r-e+1))+e:Math.random()*(r-e)+e),C=Kr,$r=(r=[])=>r[C(r.length-1)],Jt=$r;var N=p(761),H={};H.styleTagTransform=g(),H.setAttributes=f(),H.insert=x().bind(null,"head"),H.domAPI=m(),H.insertStyleElement=b();var $o=h()(N.Ay,H);const Xo=N.Ay&&N.Ay.locals?N.Ay.locals:void 0,qt=r=>r?.length?Jt(r):A(),Xr=({list:r=10,height:e="240px",space:t="25px",itemWidth:i="30px",colors:a=[],color:s,style:n,className:o,..._})=>(0,l.jsx)("div",{className:`${N.fV}${o?` ${o}`:""}`,style:{"--height":e,...n},..._,children:(Array.isArray(r)?r:[...new Array(r)]).map((d,c)=>(0,l.jsx)("div",{className:N.nb,style:{"--space":t,"--itemWidth":i,"--bgColor":d?.color??s??`linear-gradient(to top, ${qt(a)}, ${qt(a)})`,"--itemHeight":d?.height??`${C(15,100)}%`,left:`${c*(j(t)+j(i))}px`}},`huxy-skeleton-barchart-${c}`))}),Yr=Xr;var M=p(960),J={};J.styleTagTransform=g(),J.setAttributes=f(),J.insert=x().bind(null,"head"),J.domAPI=m(),J.insertStyleElement=b();var Yo=h()(M.Ay,J);const ko=M.Ay&&M.Ay.locals?M.Ay.locals:void 0,kr=({height:r="120px",leftColor:e,rightColor:t,topWidth:i,bottomWidth:a,style:s,className:n,...o})=>(0,l.jsxs)("div",{className:`${M.y8}${n?` ${n}`:""}`,style:{"--height":r,"--leftColor":e??A(),"--rightColor":t??A(),"--topWidth":i??`${C(30,60)}%`,"--bottomWidth":a??`${C(55,95)}%`,...s},...o,children:[(0,l.jsx)("div",{className:M.gY,children:(0,l.jsx)("div",{className:M.qF})}),(0,l.jsxs)("div",{className:M.zS,children:[(0,l.jsx)("h4",{className:M.DD}),(0,l.jsx)("p",{className:M.Qq})]})]}),Fr=kr;var G=p(202),Z={};Z.styleTagTransform=g(),Z.setAttributes=f(),Z.insert=x().bind(null,"head"),Z.domAPI=m(),Z.insertStyleElement=b();var Fo=h()(G.Ay,Z);const No=G.Ay&&G.Ay.locals?G.Ay.locals:void 0,Nr=[{borderWidth:"2px",borderRightColor:"rgba(2, 255, 255, 0.15)",borderTopColor:"rgba(2, 255, 255, 0.15)",borderBottomColor:"rgba(2, 255, 255, 0.15)",time:"5s"},{borderWidth:"5px",borderTopColor:"rgba(2, 255, 255, 0.7)",borderBottomColor:"rgba(2, 255, 255, 0.7)",time:"4s",rotateStart:"360deg",rotateEnd:"0deg"},{borderWidth:"3px",borderTopColor:"rgba(2, 255, 255, 0.5)",borderBottomColor:"rgba(2, 255, 255, 0.5)",time:"3s"},{borderWidth:"4px",borderTopColor:"rgba(2, 255, 255, 0.15)",time:"2s",rotateStart:"360deg",rotateEnd:"0deg"}],Hr=({size:r="300px",space:e="8px",style:t,className:i,...a})=>{const s=j(e)*3;return(0,l.jsx)("div",{className:`${G.T8}${i?` ${i}`:""}`,style:{"--size":r,...t},...a,children:Nr.map((n,o)=>{const _=s+j(n.borderWidth)*2+j(e)*2;return(0,l.jsx)("div",{className:G.c6,style:{"--itemSize":`calc(${r} - ${_}px)`,"--borderWidth":n.borderWidth,"--borderLeftColor":n.borderLeftColor,"--borderRightColor":n.borderRightColor,"--borderTopColor":n.borderTopColor,"--borderBottomColor":n.borderBottomColor,"--time":n.time,"--rotateStart":n.rotateStart,"--rotateEnd":n.rotateEnd}},`huxy-animate-border-circle-${o}`)})})},Jr=Hr;var V=p(434),Q={};Q.styleTagTransform=g(),Q.setAttributes=f(),Q.insert=x().bind(null,"head"),Q.domAPI=m(),Q.insertStyleElement=b();var Ho=h()(V.Ay,Q);const Jo=V.Ay&&V.Ay.locals?V.Ay.locals:void 0,Gr=({size:r="400px",width:e="20px",space:t="20px",colors:i=[],style:a,className:s,...n})=>(0,l.jsx)("div",{className:`${V.OH}${s?` ${s}`:""}`,style:{"--size":r,"--width":e,"--space":t,"--color1":i[0],"--color2":i[1],"--color3":i[2],"--color4":i[3],"--color5":i[4],"--color6":i[5],"--color7":i[6],...a},...n,children:(0,l.jsx)("div",{className:V.zx})}),Zr=Gr;var q=p(78),tt={};tt.styleTagTransform=g(),tt.setAttributes=f(),tt.insert=x().bind(null,"head"),tt.domAPI=m(),tt.insertStyleElement=b();var Go=h()(q.Ay,tt);const Zo=q.Ay&&q.Ay.locals?q.Ay.locals:void 0,Vr=({row:r=8,leftColor:e="linear-gradient(to right, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.15))",rightColor:t="rgba(0, 0, 0, 0.2)",rightWidth:i="100px",itemHeight:a="20px",space:s="20px",className:n,...o})=>(0,l.jsx)("div",{className:`${q.MY}${n?` ${n}`:""}`,style:{"--rightWidth":i,"--itemHeight":a,"--space":s,"--leftColor":e,"--rightColor":t},...o,children:[...new Array(r)].map((_,d)=>(0,l.jsx)("div",{className:q.cw},`huxy-skeleton-list-${d}`))}),Qr=Vr,qr=(r,e=100)=>{const t=[];return[...new Array(r)].map((i,a)=>{a===r-1?t[a]=e:(t[a]=C(1,e-1),e-=t[a])}),t},te=qr;var Mt=p(736),rt={};rt.styleTagTransform=g(),rt.setAttributes=f(),rt.insert=x().bind(null,"head"),rt.domAPI=m(),rt.insertStyleElement=b();var Vo=h()(Mt.A,rt);const Qo=Mt.A&&Mt.A.locals?Mt.A.locals:void 0,Yt=r=>r?.length?Jt(r):A(),et=te(4),re=({height:r,colors:e=[],style:t,className:i,...a})=>(0,l.jsx)("div",{className:`${Mt.q}${i?` ${i}`:""}`,style:{"--height":r,"--color1":Yt(e),"--color2":Yt(e),"--color3":Yt(e),"--color4":Yt(e),"--percent1":`${et[0]}%`,"--percent2":`${et[0]+et[1]}%`,"--percent3":`${et[0]+et[1]+et[2]}%`,"--percent4":"100%",...t},...a}),ee=re;var Ot=p(985),ot={};ot.styleTagTransform=g(),ot.setAttributes=f(),ot.insert=x().bind(null,"head"),ot.domAPI=m(),ot.insertStyleElement=b();var qo=h()(Ot.A,ot);const ta=Ot.A&&Ot.A.locals?Ot.A.locals:void 0,oe=({percent:r,height:e="20px",bgColor:t="rgba(0, 0, 0, 0.15)",progressColor:i,borderRadius:a="4px",waveColor:s="rgba(255, 255, 255, 0.2)",waveTime:n="3s",style:o,className:_,...d})=>(0,l.jsx)("div",{className:`${Ot.f}${_?` ${_}`:""}`,style:{"--percent":r??C(33,99),"--height":e,"--bgColor":t,"--progressColor":i??A(),"--borderRadius":a,"--waveColor":s,"--waveTime":n,...o},...d}),ae=oe;var at=p(804),st={};st.styleTagTransform=g(),st.setAttributes=f(),st.insert=x().bind(null,"head"),st.domAPI=m(),st.insertStyleElement=b();var ra=h()(at.Ay,st);const ea=at.Ay&&at.Ay.locals?at.Ay.locals:void 0,se=({list:r=60,size:e="300px",itemWidth:t="30px",itemHeight:i="4px",bgColor:a="rgba(255, 255, 255 , 0.9)",shadowColor:s="rgba(255, 255, 255 , 0.6)",color:n,style:o,className:_,...d})=>(r=Array.isArray(r)?r:[...new Array(r)],(0,l.jsx)("div",{className:`${at.HZ}${_?` ${_}`:""}`,style:{"--size":e,"--itemWidth":t,"--itemHeight":i,"--bgColor":a,"--shadowColor":s,...o},...d,children:r.map((c,y)=>(0,l.jsx)("div",{className:at.YZ,style:{"--color":c?.color??n??A(),transform:`rotate(${360/r.length*y}deg)`}},`huxy-animate-border-ring-${y}`))})),ie=se;var it=p(261),nt={};nt.styleTagTransform=g(),nt.setAttributes=f(),nt.insert=x().bind(null,"head"),nt.domAPI=m(),nt.insertStyleElement=b();var oa=h()(it.Ay,nt);const aa=it.Ay&&it.Ay.locals?it.Ay.locals:void 0,ne=({children:r,hasTitle:e,titleBgColor:t,style:i,className:a,...s})=>(0,l.jsx)("div",{className:`${it.ao}${e?` ${it.DD}`:""}${a?` ${a}`:""}`,style:{"--titleBgColor":t??A(),...i},...s,children:r}),_e=ne;var Tt=p(826),_t={};_t.styleTagTransform=g(),_t.setAttributes=f(),_t.insert=x().bind(null,"head"),_t.domAPI=m(),_t.insertStyleElement=b();var sa=h()(Tt.A,_t);const ia=Tt.A&&Tt.A.locals?Tt.A.locals:void 0,de=({row:r=6,col:e=8,...t})=>(0,l.jsx)("div",{className:Tt.K,...t,children:(0,l.jsxs)("table",{children:[(0,l.jsx)("thead",{children:(0,l.jsx)("tr",{children:[...new Array(e)].map((i,a)=>(0,l.jsx)("th",{children:(0,l.jsx)("span",{})},`skeleton-table-th-${a}`))})}),(0,l.jsx)("tbody",{children:[...new Array(r)].map((i,a)=>(0,l.jsx)("tr",{children:[...new Array(e)].map((s,n)=>(0,l.jsx)("td",{children:(0,l.jsx)("span",{})},`skeleton-table-tr-${a}-${n}`))},`tr-${a}`))})]})}),le=de;var Rt=p(763),dt={};dt.styleTagTransform=g(),dt.setAttributes=f(),dt.insert=x().bind(null,"head"),dt.domAPI=m(),dt.insertStyleElement=b();var na=h()(Rt.A,dt);const _a=Rt.A&&Rt.A.locals?Rt.A.locals:void 0,ce=({color:r="rgba(255, 255, 255, 0.1)",delay:e="2s",style:t,className:i,children:a,...s})=>(0,l.jsx)("div",{className:`${Rt.h}${i?` ${i}`:""}`,style:{"--waveColor":r,"--waveTime":e,...t},...s,children:a}),pe=ce;var St=p(888),lt={};lt.styleTagTransform=g(),lt.setAttributes=f(),lt.insert=x().bind(null,"head"),lt.domAPI=m(),lt.insertStyleElement=b();var da=h()(St.A,lt);const la=St.A&&St.A.locals?St.A.locals:void 0,ue=r=>(0,l.jsx)("span",{className:St.p,...r}),ve=ue;var jt=p(981),ct={};ct.styleTagTransform=g(),ct.setAttributes=f(),ct.insert=x().bind(null,"head"),ct.domAPI=m(),ct.insertStyleElement=b();var ca=h()(jt.A,ct);const pa=jt.A&&jt.A.locals?jt.A.locals:void 0,he=r=>(0,l.jsx)("span",{className:jt.S,...r}),me=he;var Lt=p(358),pt={};pt.styleTagTransform=g(),pt.setAttributes=f(),pt.insert=x().bind(null,"head"),pt.domAPI=m(),pt.insertStyleElement=b();var ua=h()(Lt.A,pt);const va=Lt.A&&Lt.A.locals?Lt.A.locals:void 0,xe=r=>(0,l.jsx)("span",{className:Lt.l,...r}),fe=xe;var ut=p(715),vt={};vt.styleTagTransform=g(),vt.setAttributes=f(),vt.insert=x().bind(null,"head"),vt.domAPI=m(),vt.insertStyleElement=b();var ha=h()(ut.Ay,vt);const ma=ut.Ay&&ut.Ay.locals?ut.Ay.locals:void 0,be=({list:r=7,size:e="40px",shadowSize:t="50px",time:i="1.6s",style:a,className:s,...n})=>(i=j(i,"s"),(0,l.jsx)("div",{className:`${ut.Y2}${s?` ${s}`:""}`,style:{"--size":e,"--shadowSize":t,"--time":`${i}s`,...a},...n,children:(Array.isArray(r)?r:[...new Array(r)]).map((o,_)=>(0,l.jsx)("div",{className:ut.iU,style:{"--delay":o?.delay??`${i/((r?.length??r)+1)*(_+1)-i}s`,"--bgColor":o?.color??A()}},`huxy-loading-ball-${_}`))})),ge=be;var ht=p(925),mt={};mt.styleTagTransform=g(),mt.setAttributes=f(),mt.insert=x().bind(null,"head"),mt.domAPI=m(),mt.insertStyleElement=b();var xa=h()(ht.Ay,mt);const Ee=ht.Ay&&ht.Ay.locals?ht.Ay.locals:void 0,ye=({type:r="spot",size:e,color:t,shadowColor:i,style:a,className:s,...n})=>(0,l.jsx)("span",{className:`${Ht[`huxy-${r}`]}${s?` ${s}`:""}`,style:{"--size":e??`${C(6,30)}px`,"--color":t??A(),"--shadowColor":i??A(),...a},...n}),Ae=ye;var Bt=p(816),xt={};xt.styleTagTransform=g(),xt.setAttributes=f(),xt.insert=x().bind(null,"head"),xt.domAPI=m(),xt.insertStyleElement=b();var fa=h()(Bt.A,xt);const ba=Bt.A&&Bt.A.locals?Bt.A.locals:void 0,Ce=({width:r,border:e,black:t,white:i,style:a,className:s,...n})=>(0,l.jsx)("div",{className:`${Bt.f} ${s}`,style:{"--width":r,"--border":e,"--black":t,"--white":i,...a},...n}),Pe=Ce;var Wt=p(875),ft={};ft.styleTagTransform=g(),ft.setAttributes=f(),ft.insert=x().bind(null,"head"),ft.domAPI=m(),ft.insertStyleElement=b();var ga=h()(Wt.A,ft);const Ea=Wt.A&&Wt.A.locals?Wt.A.locals:void 0,De=({width:r="200px",height:e="180px",space:t="12%",bgColor:i,style:a,className:s,...n})=>(0,l.jsx)("div",{className:`${Wt.V}${s?` ${s}`:""}`,style:{"--width":r,"--height":e,"--space":t,"--bgColor":i,...a},...n}),Me=De;var kt=p(333),bt={};bt.styleTagTransform=g(),bt.setAttributes=f(),bt.insert=x().bind(null,"head"),bt.domAPI=m(),bt.insertStyleElement=b();var ya=h()(kt.A,bt);const Aa=kt.A&&kt.A.locals?kt.A.locals:void 0,Gt=()=>Math.random()-.5,Oe=()=>~~(Gt()*C(5,10)*10),Te=()=>~~(Gt()*C(2,8)*10),Re=()=>(1-Gt())*C(1.1,1.4,!1),Se=r=>r?.length?Jt(r):A(),je=({list:r=[],colors:e=[],width:t,padding:i,bgColor:a,style:s,...n})=>(0,l.jsx)("div",{className:"huxy-text-3d",style:{"--width":t,"--padding":i,"--bgColor":a,...s},...n,children:(0,l.jsx)("div",{className:"text-3d-container",children:r.map((o,_)=>{const d=o.time??C(6,24,!1).toFixed(2),c=o.delay??-C(0,d,!1).toFixed(2);return(0,l.jsx)("div",{className:"text-3d-item",style:{"--time":`${d}s`,"--center":o.center??`${Oe()}%`,"--rotate":o.rotate??`${Te()}deg`,"--size":o.size??Re(),"--color":o.color??Se(e),"--delay":`${c}s`},children:(0,l.jsx)("div",{className:"text-3d-item-card",children:(0,l.jsx)("span",{className:"link animate-text",children:o.label})})},o.label)})})}),Le=je;var gt=p(588),Et={};Et.styleTagTransform=g(),Et.setAttributes=f(),Et.insert=x().bind(null,"head"),Et.domAPI=m(),Et.insertStyleElement=b();var Ca=h()(gt.Ay,Et);const Pa=gt.Ay&&gt.Ay.locals?gt.Ay.locals:void 0,Be=({time:r="3s",style:e,className:t,children:i,...a})=>(0,l.jsx)("div",{className:`${gt.eq}${t?` ${t}`:""}`,style:{"--time":r,...e},...a,children:(0,l.jsx)("div",{className:gt.Rz,children:i})}),We=Be;var It=p(722),yt={};yt.styleTagTransform=g(),yt.setAttributes=f(),yt.insert=x().bind(null,"head"),yt.domAPI=m(),yt.insertStyleElement=b();var Da=h()(It.A,yt);const Ma=It.A&&It.A.locals?It.A.locals:void 0,Ie=({backColor:r="rgba(0, 0, 0, 0.3)",frontColor:e="rgba(255, 255, 255, 1)",time:t="4s",style:i,className:a,children:s,...n})=>(0,l.jsx)("div",{className:`${It.e}${a?` ${a}`:""}`,style:{"--backColor":r,"--frontColor":e,"--time":t,...i},...n,"data-text":s,children:s}),Ue=Ie;var Ut=p(547),At={};At.styleTagTransform=g(),At.setAttributes=f(),At.insert=x().bind(null,"head"),At.domAPI=m(),At.insertStyleElement=b();var Oa=h()(Ut.A,At);const Ta=Ut.A&&Ut.A.locals?Ut.A.locals:void 0,ze=({startColor:r,endColor:e,style:t,className:i,children:a,...s})=>(0,l.jsx)("div",{className:`${Ut.v}${i?` ${i}`:""}`,style:{"--startColor":r??A(),"--endColor":e??A(),...t},...s,children:a}),we=ze;var zt=p(175),Ct={};Ct.styleTagTransform=g(),Ct.setAttributes=f(),Ct.insert=x().bind(null,"head"),Ct.domAPI=m(),Ct.insertStyleElement=b();var Ra=h()(zt.A,Ct);const Sa=zt.A&&zt.A.locals?zt.A.locals:void 0,Ke=({score:r=0,backColor:e="rgba(0, 0, 0, 0.3)",frontColor:t="var(--yellow2)",style:i,className:a,children:s,backend:n,...o})=>(0,l.jsx)("div",{className:`${zt.J}${a?` ${a}`:""}`,style:{"--backColor":e,"--frontColor":t,"--score":`${r}`.includes("%")?r:`${r*100}%`,...i},...o,"data-text":s,children:n??s}),$e=Ke;var Xe=v.sC,Ye=v.S9,ke=v.ji,Fe=v.Zp,Ne=v.jl,He=v.mc,Je=v.ax,Ge=v.e8,Ze=v.xh,Ve=v.Lv,Qe=v.C7,qe=v.De,to=v.yz,ro=v.ve,eo=v.B8,oo=v.Rh,ao=v.aZ,so=v.VJ,io=v.ke,no=v.LI,_o=v.Jn,lo=v.vj,co=v.P1,po=v.XI,uo=v.cp,vo=v.xw,ho=v.U$,mo=v.E8,xo=v.dF,fo=v.gX,bo=v.nQ,go=v.Ub,Eo=v.wH;export{Xe as AnimateBorder,Ye as Barchart,ke as BgBox,Fe as Card,Ne as Circle,He as Container,Je as CornerBorder,Ge as Css3dModel,Ze as Dashboard,Ve as Fliper,Qe as HalfBorder,qe as IconAnimate,to as IconCarousel,ro as Light,eo as List,oo as Loading,ao as Location,so as Piechart,io as Progress,no as RateScore,_o as Ring,lo as Search,co as Spot,po as Table,uo as Taiji,vo as Text3d,ho as TextFilter,mo as TextLoading,xo as TextMasked,fo as Time,bo as TitleBorder,go as TitleHeader,Eo as Wave};
